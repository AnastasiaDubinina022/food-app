...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let sex = 'female'; // 
    let ratio = 1.375;  // задаем значения по умолчанию
    ...
    function getStaticInformation(parentSelector, activeClass) {    // получение информации со статических блоков (пол и активность, 1 функция т.к. они одинаковые)
